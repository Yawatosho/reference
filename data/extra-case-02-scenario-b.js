export const EXTRA_CASE_02_SCENARIO_B = {
  ...
  questions: [
    ...
    },
    {
      ...
      text: "では、義務の対象でないなら、今回はOAにしなくてもよさそうですか？",
      requiresAll: ["not_mandatory_scope"],
      requiresAny: [],
      response:
        "義務じゃないなら、その点は安心しました。でも……できれば読める人は増やしたいんですよね。OAにしなくていい、と決めたいわけではないんです。",
      responseVariants: [
        "制度上しなくてもいい、ということは分かりました。ただ、それとは別に、公開できるなら公開したい気持ちはあります。",
      ],
      reveals: ["still_wants_open"],
    },
    {
      id: "q_ex2b_why_open",
      text: "義務とは別にOAにしたいとすると、先生が期待しているのはどんなことでしょう？",
      requiresAll: ["still_wants_open"],
      requiresAny: [],
      response:
        "研究者だけでなく、大学に所属していない人でも読めるようになればいいなと思っています。せっかく出した研究なので、アクセスできる人は多いほうがうれしいです。",
      responseVariants: [
        "制度のためというより、読める人を限定しなくて済むなら、そのほうがいいなと思っています。",
      ],
      reveals: ["access_goal"],
    },
    {
    ...
    },
    {
      ...
      text:
        "つまり、今回は即時OAの義務に対応することが目的ではなくて、論文を広く読めるようにするために、出版社のOAも含めて利用できる公開方法と条件を比べてから選びたい、ということでしょうか？",
      requiresAll: ["not_mandatory_scope", "access_goal", "options_unclear"],
      requiresAny: [],
      response:
        "はい、それです。最初は『APCを払うか』だと思っていたんですけど、そうじゃないですね。どんな方法が使えるのかを知って、それから決めたいんです。",
      responseVariants: [
        "そうです。義務だからOAにする、という話ではなくなりましたけど、公開したい気持ちは残っています。その方法を整理したかったんですね。",
      ],
