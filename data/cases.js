    ...
    questions: [
      {
        ...
        requiresAll: [],
        requiresAny: [],
        response: "1年だけじゃなくて、前から今までの流れを追いたいな。",
        responseVariants: ["特定の1年じゃなくて、過去から現在までの数字が必要だよ。"],
      ...
      },
      {
        ...
        requiresAll: [],
        requiresAny: [],
        response: "授業のレポートで、大学生の人数の変化を説明するつもり。",
      ...
      },
      {
        ...
        responseVariants: ["地域別じゃなくて、全国を合計した人数を探してるよ。"],
        reveals: ["japan_total"],
      },
      {
        id: "q05_explain",
        ...
        requiresAll: ["report"],
        requiresAny: [],
        response: "大学生の数が昔より増えたのか、減ったのかを示したいな。",
        responseVariants: ["以前と比べて、大学生数が増えたか減ったかを説明したいよ。"],
      ...
      },
      {
        ...
        response: "うん。現在の数字だけじゃなくて、過去からの変化を比べてみたいな。",
      ...
      },
      {
        ...
        requiresAny: [],
        response: "うん。始点と終点だけじゃなくて、年ごとの推移をグラフにしたいな。",
      ...
      },
      {
        ...
        responseVariants: ["グラフの色にはこだわらないよ。今は統計データそのものを探してるところ。"],
        reveals: [],
        distractor: "plausible",
      },
      {
        ...
        requiresAll: [],
        requiresAny: [],
        response: "商店街をぶらぶら歩くのが好き！ 面白い看板や小さな路地を見つけると、ちょっと得した気分になるよ。",
        responseVariants: ["喫茶店で新作パフェを試すことかな。メニューの写真と見比べるのも、けっこう楽しいよ！"],
        reveals: ["smalltalk_followup"],
        distractor: "irrelevant",
        distractorTone: "cheerful",
      },
      {
        ...
        responseVariants: ["喫茶店のプリンに、小さな探偵帽みたいなクリームが乗ってたよ。思わず写真を撮っちゃった！"],
        reveals: [],
        smallTalkFollowUp: true,
      },
    ],
        ...
        purpose: [
          {
            ...
            values: {
              ...
              statisticUseReply: "授業のレポートに使う予定だよ。",
          ...
          },
          {
            ...
            values: {
              ...
              statisticUseReply: "進路支援に使う予算資料を作ってるところ。",
          ...
          },
          {
            ...
            values: {
              ...
              statisticUseReply: "大学広報で、女性研究者を紹介する記事を作る予定だよ。",
        ...
        target: [
          {
            ...
            values: {
              ...
              statisticGoalReply: "大学生の数が以前より増えたか減ったかを示したいな。",
              statisticGoalReplyAlt: "大学生数の長期的な増減を説明したいよ。",
            },
          },
          {
            ...
            values: {
              ...
              targetReplyAlt: "大学院修了者じゃなくて、大学の卒業者数を探してるよ。",
              statisticGoalFact: "大学卒業者数の増減",
              statisticGoalReply: "大学卒業者の数が最近どう変わったかを比較したいな。",
          ...
          },
          {
            ...
            values: {
              ...
              targetReplyAlt: "大学で研究に携わる女性を対象にした数字が目当てだよ。",
              statisticGoalFact: "女性研究者の分野別構成",
              statisticGoalReply: "女性研究者がどの研究分野に多いか、内訳を示したいな。",
              statisticGoalReplyAlt: "総数の増減より、分野ごとの人数の違いを説明したいよ。",
            },
          },
        ],
        period: [
          {
            ...
            values: {
              ...
              yearReply: "1年だけじゃなくて、20年ほど前から現在までを追いたいな。",
              yearReplyAlt: "直近約20年について、複数年の数字をそろえたいな。",
          ...
          },
          {
            ...
            values: {
              ...
              yearReply: "1年分じゃなくて、最近5年ほどを比べたいな。",
              yearReplyAlt: "直近約5年について、複数年の数字を集めたいよ。",
              spanReply: "まずは直近5年ほどを比較できれば十分だよ。",
              spanReplyAlt: "長期じゃなくて、最近5年間を見たいかな。",
            },
          },
          {
            optionId: "period_10",
            ...
            values: {
              ...
              yearReply: "直近10年ほどの数字を見たいな。1年分だけじゃ足りないよ。",
              yearReplyAlt: "およそ10年前から現在までの資料が必要だね。",
              spanReply: "広報記事では、直近10年ほどを扱う予定だよ。",
              spanReplyAlt: "長すぎないよう、最近10年間に絞るつもり。",
            },
          },
        ],
        statistic: [
          {
            ...
            values: {
              ...
              compareReply: "うん。毎年の数字を並べて、変化を比べてみたいな。",
              compareReplyAlt: "最新値だけじゃなくて、年ごとの推移まで追えると助かるな。",
              seriesReply: "うん。途中の動きも分かるよう、毎年の数値を使いたいな。",
              seriesReplyAlt: "年ごとの推移をグラフにするつもり。",
            },
          },
          {
            ...
            values: {
              ...
              compareReply: "うん。いくつかの年を並べて、違いを確かめたいな。",
              compareReplyAlt: "最新年だけじゃなくて、複数年を比べられる数字がほしいな。",
              seriesReply: "毎年じゃなくても、複数の年を比較できれば十分だよ。",
              seriesReplyAlt: "代表的な年をいくつか比べられる形がよさそう。",
            },
          },
          {
            ...
            values: {
              ...
              compareReply: "年ごとの総数より、同じ年の研究分野別の内訳を比べたいな。",
              compareReplyAlt: "複数年の総数じゃなくて、分野ごとの人数が分かる表があるとうれしいな。",
              seriesReply: "毎年の推移より、研究分野別の内訳を同じ基準で比較したい。",
