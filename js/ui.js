...
export function resultScreen(session, progress, hasNextCase, options = {}) {
  ...
  return shell(`
    <section class="result-page result-page--revealing" style="--case-accent:${escapeHtml(caseData.patron.accent)}" data-result-reveal aria-busy="true">
      ...
      <div class="result-hero" data-result-rank-panel>
