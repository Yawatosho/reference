...
test("公開URLをcanonicalとSNSメタデータへ絶対URLで設定する", () => {
  ...
  assert.match(
    files["index.html"],
    /property="og:image" content="https:\/\/yawatosho\.github\.io\/reference\/assets\/ogp\/ogp\.png"/,
  );
  assert.match(
    files["index.html"],
    /name="twitter:image" content="https:\/\/yawatosho\.github\.io\/reference\/assets\/ogp\/ogp\.png"/,
  );
});
...
test("タイトル画像からOGP・ファビコン・ホーム画面アイコンを配信する", () => {
  assert.match(files["index.html"], /property="og:image" content="https:\/\/yawatosho\.github\.io\/reference\/assets\/ogp\/ogp\.png"/);
